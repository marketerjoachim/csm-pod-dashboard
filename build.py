...
<div id="dashboard" class="locked max-w-[1500px] mx-auto px-4 sm:px-6 py-8">
  ...
  <div class="glass rounded-xl overflow-hidden fade-in" style="animation-delay:0.25s">
    ...
    <div class="overflow-x-auto scrollbar-thin" id="tableScroll">
      <table class="w-full text-sm" style="table-layout:fixed" id="mainTable">
        <thead>
...
(function(){{
  ...
  // Set initial widths from computed size, then lock them
  requestAnimationFrame(function(){{
    ...
    ths.forEach(function(th,i){{
      ...
      let startX,startW,nextTh,nextW;
      handle.addEventListener('mousedown',function(e){{
        ...
        nextTh=ths[i+1];
        nextW=nextTh?nextTh.offsetWidth:0;
        ...
        function onMove(e2){{
          ...
          if(nextTh)nextTh.style.width=Math.max(40,nextW-dx)+'px';
        }}
        function onUp(){{
