...
function renderDailyCards(){{
  ...
  agEl.innerHTML=`
    <div class="grid grid-cols-7 gap-2 items-center">
      ...
      <div class="text-center"><p class="text-xl font-700 ${{agChurnColor}}">${{totChurnCnt>0?totChurnCnt+' ('+fmtChurnArr(totChurnArr)+')':'0'}}</p><p class="text-dark-400 text-xs font-600">Churned</p></div>
      <div class="text-center"><p class="text-xl font-700 ${{totRenCnt>0?'text-emerald-400':'text-dark-500'}}">${{totRenCnt>0?totRenCnt+' ('+fmtChurnArr(totRenMrr)+')':'0'}}</p><p class="text-dark-400 text-xs font-600">Renewed</p></div>
